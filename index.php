...
?>
      <div class="row">
        ...
        <div class="col-lg-6">
          <img class="title-image" src="/public/images/main-book.jpg" alt="iphone-mockup">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="white-section">
    <div id="NewBooksCarousel" class="carousel slide new-books" data-ride="carousel">
  ...
  <section class="white-section">
    <div id="DealsCarousel" class="carousel slide new-books" data-ride="carousel">
      <div class="carousel-inner">
